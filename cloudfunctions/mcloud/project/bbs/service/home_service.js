...
class HomeService extends BaseProjectService {
	...
	async getHomeList() {
		...
		let fields = 'PRODUCT_PIC,PRODUCT_TITLE,PRODUCT_CATE_NAME,PRODUCT_OBJ.cover';
		...
		fields = 'PRODUCT_GOOD,PRODUCT_PIC,PRODUCT_ADD_TIME,PRODUCT_TITLE,PRODUCT_CATE_NAME,PRODUCT_FAV_CNT,PRODUCT_LIKE_CNT,PRODUCT_COMMENT_CNT,PRODUCT_VIEW_CNT,PRODUCT_OBJ.cover';
		...
		fields = 'CATE1_TITLE,CATE1_OBJ.cover,CATE1_OBJ.desc';
		...
		fields = 'USER_NAME,USER_PIC,USER_MINI_OPENID';
		let userList = await UserModel.getAll(where, fields, orderBy, 6);


		return { userList, cateList, swiper, vouchList, hotList }

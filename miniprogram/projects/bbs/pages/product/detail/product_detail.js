...
Page({
	...
	bindLikeCommentTap: async function (e) {
		...
		let list = this.data.product.commentList;

		await CommentBiz.likeComment(this, list, id, idx, 'product.commentList');
	},
	...
	bindDelCommentTap: async function (e) {
		...
		await CommentBiz.delComment(this, commentId, 'product.commentList');
